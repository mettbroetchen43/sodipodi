...
static void sp_canvas_acetate_update (SPCanvasItem *item, const NRMatrixD *ctm, unsigned int flags);
...
static void
sp_canvas_acetate_update (SPCanvasItem *item, const NRMatrixD *ctm, unsigned int flags)
{
	item->x1 = -G_MAXINT;
	item->y1 = -G_MAXINT;
	item->x2 = G_MAXINT;
