...
double parse_num (MyGt1String *number)
{
  double sign;
  double mantissa;
  double decimal;
...
internal_closefile (Gt1PSContext *psc)
{
  ...
  if (get_stack_file (psc, &tc, 1))
	...
	{
	  /* pop the file stack */
	  /* todo: deallocate some of the tc context */
	  psc->n_files--;
...
gt1_load_font (char *filename)
{
  ...
  */
  ...
  stdenc = gt1_new (Gt1NameId, 256);
  for (i = 0; i < 256; i++)
    stdenc[i] = gt1_name_context_intern (psc->nc, ".notdef");
  stdenc[32] = gt1_name_context_intern (psc->nc, "space");
  stdenc[33] = gt1_name_context_intern (psc->nc, "exclam");
  stdenc[34] = gt1_name_context_intern (psc->nc, "quotedbl");
  stdenc[35] = gt1_name_context_intern (psc->nc, "numbersign");
  stdenc[36] = gt1_name_context_intern (psc->nc, "dollar");
  stdenc[37] = gt1_name_context_intern (psc->nc, "percent");
  stdenc[38] = gt1_name_context_intern (psc->nc, "ampersand");
  stdenc[39] = gt1_name_context_intern (psc->nc, "quoteright");
  stdenc[40] = gt1_name_context_intern (psc->nc, "parenleft");
  stdenc[41] = gt1_name_context_intern (psc->nc, "parenright");
  stdenc[42] = gt1_name_context_intern (psc->nc, "asterisk");
  stdenc[43] = gt1_name_context_intern (psc->nc, "plus");
  stdenc[44] = gt1_name_context_intern (psc->nc, "comma");
  stdenc[45] = gt1_name_context_intern (psc->nc, "hyphen");
  stdenc[46] = gt1_name_context_intern (psc->nc, "period");
  stdenc[47] = gt1_name_context_intern (psc->nc, "slash");
  stdenc[48] = gt1_name_context_intern (psc->nc, "zero");
  stdenc[49] = gt1_name_context_intern (psc->nc, "one");
  stdenc[50] = gt1_name_context_intern (psc->nc, "two");
  stdenc[51] = gt1_name_context_intern (psc->nc, "three");
  stdenc[52] = gt1_name_context_intern (psc->nc, "four");
  stdenc[53] = gt1_name_context_intern (psc->nc, "five");
  stdenc[54] = gt1_name_context_intern (psc->nc, "six");
  stdenc[55] = gt1_name_context_intern (psc->nc, "seven");
  stdenc[56] = gt1_name_context_intern (psc->nc, "eight");
  stdenc[57] = gt1_name_context_intern (psc->nc, "nine");
  stdenc[58] = gt1_name_context_intern (psc->nc, "colon");
  stdenc[59] = gt1_name_context_intern (psc->nc, "semicolon");
  stdenc[60] = gt1_name_context_intern (psc->nc, "less");
  stdenc[61] = gt1_name_context_intern (psc->nc, "equal");
  stdenc[62] = gt1_name_context_intern (psc->nc, "greater");
  stdenc[63] = gt1_name_context_intern (psc->nc, "question");
  stdenc[64] = gt1_name_context_intern (psc->nc, "at");
  stdenc[65] = gt1_name_context_intern (psc->nc, "A");
  stdenc[66] = gt1_name_context_intern (psc->nc, "B");
  stdenc[67] = gt1_name_context_intern (psc->nc, "C");
  stdenc[68] = gt1_name_context_intern (psc->nc, "D");
  stdenc[69] = gt1_name_context_intern (psc->nc, "E");
  stdenc[70] = gt1_name_context_intern (psc->nc, "F");
  stdenc[71] = gt1_name_context_intern (psc->nc, "G");
  stdenc[72] = gt1_name_context_intern (psc->nc, "H");
  stdenc[73] = gt1_name_context_intern (psc->nc, "I");
  stdenc[74] = gt1_name_context_intern (psc->nc, "J");
  stdenc[75] = gt1_name_context_intern (psc->nc, "K");
  stdenc[76] = gt1_name_context_intern (psc->nc, "L");
  stdenc[77] = gt1_name_context_intern (psc->nc, "M");
  stdenc[78] = gt1_name_context_intern (psc->nc, "N");
  stdenc[79] = gt1_name_context_intern (psc->nc, "O");
  stdenc[80] = gt1_name_context_intern (psc->nc, "P");
  stdenc[81] = gt1_name_context_intern (psc->nc, "Q");
  stdenc[82] = gt1_name_context_intern (psc->nc, "R");
  stdenc[83] = gt1_name_context_intern (psc->nc, "S");
  stdenc[84] = gt1_name_context_intern (psc->nc, "T");
  stdenc[85] = gt1_name_context_intern (psc->nc, "U");
  stdenc[86] = gt1_name_context_intern (psc->nc, "V");
  stdenc[87] = gt1_name_context_intern (psc->nc, "W");
  stdenc[88] = gt1_name_context_intern (psc->nc, "X");
  stdenc[89] = gt1_name_context_intern (psc->nc, "Y");
  stdenc[90] = gt1_name_context_intern (psc->nc, "Z");
  stdenc[91] = gt1_name_context_intern (psc->nc, "bracketleft");
  stdenc[92] = gt1_name_context_intern (psc->nc, "backslash");
  stdenc[93] = gt1_name_context_intern (psc->nc, "bracketright");
  stdenc[94] = gt1_name_context_intern (psc->nc, "asciicircum");
  stdenc[95] = gt1_name_context_intern (psc->nc, "underscore");
  stdenc[96] = gt1_name_context_intern (psc->nc, "quoteleft");
  stdenc[97] = gt1_name_context_intern (psc->nc, "a");
  stdenc[98] = gt1_name_context_intern (psc->nc, "b");
  stdenc[99] = gt1_name_context_intern (psc->nc, "c");
  stdenc[100] = gt1_name_context_intern (psc->nc, "d");
  stdenc[101] = gt1_name_context_intern (psc->nc, "e");
  stdenc[102] = gt1_name_context_intern (psc->nc, "f");
  stdenc[103] = gt1_name_context_intern (psc->nc, "g");
  stdenc[104] = gt1_name_context_intern (psc->nc, "h");
  stdenc[105] = gt1_name_context_intern (psc->nc, "i");
  stdenc[106] = gt1_name_context_intern (psc->nc, "j");
  stdenc[107] = gt1_name_context_intern (psc->nc, "k");
  stdenc[108] = gt1_name_context_intern (psc->nc, "l");
  stdenc[109] = gt1_name_context_intern (psc->nc, "m");
  stdenc[110] = gt1_name_context_intern (psc->nc, "n");
  stdenc[111] = gt1_name_context_intern (psc->nc, "o");
  stdenc[112] = gt1_name_context_intern (psc->nc, "p");
  stdenc[113] = gt1_name_context_intern (psc->nc, "q");
  stdenc[114] = gt1_name_context_intern (psc->nc, "r");
  stdenc[115] = gt1_name_context_intern (psc->nc, "s");
  stdenc[116] = gt1_name_context_intern (psc->nc, "t");
  stdenc[117] = gt1_name_context_intern (psc->nc, "u");
  stdenc[118] = gt1_name_context_intern (psc->nc, "v");
  stdenc[119] = gt1_name_context_intern (psc->nc, "w");
  stdenc[120] = gt1_name_context_intern (psc->nc, "x");
  stdenc[121] = gt1_name_context_intern (psc->nc, "y");
  stdenc[122] = gt1_name_context_intern (psc->nc, "z");
  stdenc[123] = gt1_name_context_intern (psc->nc, "braceleft");
  stdenc[124] = gt1_name_context_intern (psc->nc, "bar");
  stdenc[125] = gt1_name_context_intern (psc->nc, "braceright");
  stdenc[126] = gt1_name_context_intern (psc->nc, "asciitilde");

  stdenc[161] = gt1_name_context_intern (psc->nc, "exclamdown");
  stdenc[162] = gt1_name_context_intern (psc->nc, "cent");
  stdenc[163] = gt1_name_context_intern (psc->nc, "sterling");
  stdenc[164] = gt1_name_context_intern (psc->nc, "currency");
  stdenc[165] = gt1_name_context_intern (psc->nc, "yen");

  stdenc[167] = gt1_name_context_intern (psc->nc, "section");

  stdenc[180] = gt1_name_context_intern (psc->nc, "acute");

  stdenc[184] = gt1_name_context_intern (psc->nc, "cedilla");

  stdenc[191] = gt1_name_context_intern (psc->nc, "questiondown");
  stdenc[192] = gt1_name_context_intern (psc->nc, "Agrave");
  stdenc[193] = gt1_name_context_intern (psc->nc, "Aacute");
  stdenc[194] = gt1_name_context_intern (psc->nc, "Acircumflex");
  stdenc[195] = gt1_name_context_intern (psc->nc, "Atilde");
  stdenc[196] = gt1_name_context_intern (psc->nc, "Adieresis");
  stdenc[197] = gt1_name_context_intern (psc->nc, "Aring");
  stdenc[198] = gt1_name_context_intern (psc->nc, "AE");
  stdenc[199] = gt1_name_context_intern (psc->nc, "Ccedilla");
  stdenc[200] = gt1_name_context_intern (psc->nc, "Egrave");
  stdenc[201] = gt1_name_context_intern (psc->nc, "Eacute");
  stdenc[202] = gt1_name_context_intern (psc->nc, "Ecircumflex");
  stdenc[203] = gt1_name_context_intern (psc->nc, "Edieresis");
  stdenc[204] = gt1_name_context_intern (psc->nc, "Igrave");
  stdenc[205] = gt1_name_context_intern (psc->nc, "Iacute");
  stdenc[206] = gt1_name_context_intern (psc->nc, "Icircumflex");
  stdenc[207] = gt1_name_context_intern (psc->nc, "Idieresis");

  stdenc[209] = gt1_name_context_intern (psc->nc, "Ntilde");

  stdenc[210] = gt1_name_context_intern (psc->nc, "Ograve");
  stdenc[211] = gt1_name_context_intern (psc->nc, "Oacute");
  stdenc[212] = gt1_name_context_intern (psc->nc, "Ocircumflex");
  stdenc[213] = gt1_name_context_intern (psc->nc, "Otilde");
  stdenc[214] = gt1_name_context_intern (psc->nc, "Odieresis");

  stdenc[216] = gt1_name_context_intern (psc->nc, "Oslash");

  stdenc[217] = gt1_name_context_intern (psc->nc, "Ugrave");
  stdenc[218] = gt1_name_context_intern (psc->nc, "Uacute");
  stdenc[219] = gt1_name_context_intern (psc->nc, "Ucircumflex");
  stdenc[220] = gt1_name_context_intern (psc->nc, "Udieresis");
  stdenc[221] = gt1_name_context_intern (psc->nc, "Yacute");

  stdenc[223] = gt1_name_context_intern (psc->nc, "germandbls");

  stdenc[224] = gt1_name_context_intern (psc->nc, "agrave");
  stdenc[225] = gt1_name_context_intern (psc->nc, "aacute");
  stdenc[229] = gt1_name_context_intern (psc->nc, "acircumflex");
  stdenc[227] = gt1_name_context_intern (psc->nc, "atilde");
  stdenc[228] = gt1_name_context_intern (psc->nc, "adieresis");
  stdenc[229] = gt1_name_context_intern (psc->nc, "aring");
  stdenc[230] = gt1_name_context_intern (psc->nc, "ae");
  stdenc[231] = gt1_name_context_intern (psc->nc, "ccedilla");
  stdenc[232] = gt1_name_context_intern (psc->nc, "egrave");
  stdenc[233] = gt1_name_context_intern (psc->nc, "eacute");
  stdenc[234] = gt1_name_context_intern (psc->nc, "ecircumflex");
  stdenc[235] = gt1_name_context_intern (psc->nc, "edieresis");
  stdenc[236] = gt1_name_context_intern (psc->nc, "igrave");
  stdenc[237] = gt1_name_context_intern (psc->nc, "iacute");
  stdenc[238] = gt1_name_context_intern (psc->nc, "icircumflex");
  stdenc[239] = gt1_name_context_intern (psc->nc, "idieresis");

  stdenc[241] = gt1_name_context_intern (psc->nc, "ntilde");

  stdenc[242] = gt1_name_context_intern (psc->nc, "ograve");
  stdenc[243] = gt1_name_context_intern (psc->nc, "oacute");
  stdenc[244] = gt1_name_context_intern (psc->nc, "ocircumflex");
  stdenc[245] = gt1_name_context_intern (psc->nc, "otilde");
  stdenc[246] = gt1_name_context_intern (psc->nc, "odieresis");

  stdenc[248] = gt1_name_context_intern (psc->nc, "oslash");

  stdenc[249] = gt1_name_context_intern (psc->nc, "ugrave");
  stdenc[250] = gt1_name_context_intern (psc->nc, "uacute");
  stdenc[251] = gt1_name_context_intern (psc->nc, "ucircumflex");
  stdenc[252] = gt1_name_context_intern (psc->nc, "udieresis");
  stdenc[253] = gt1_name_context_intern (psc->nc, "Yacute");

  stdenc[255] = gt1_name_context_intern (psc->nc, "ydieresis");
#if 0
  stdenc[164] = gt1_name_context_intern (psc->nc, "fraction");

  stdenc[166] = gt1_name_context_intern (psc->nc, "florin");

  stdenc[169] = gt1_name_context_intern (psc->nc, "quotesingle");
  stdenc[170] = gt1_name_context_intern (psc->nc, "quotedblleft");
  stdenc[171] = gt1_name_context_intern (psc->nc, "guillemotleft");
  stdenc[172] = gt1_name_context_intern (psc->nc, "guilsinglleft");
  stdenc[173] = gt1_name_context_intern (psc->nc, "guilsinglright");
  stdenc[174] = gt1_name_context_intern (psc->nc, "fi");
  stdenc[175] = gt1_name_context_intern (psc->nc, "fl");
  stdenc[177] = gt1_name_context_intern (psc->nc, "endash");
  stdenc[178] = gt1_name_context_intern (psc->nc, "dagger");
  stdenc[179] = gt1_name_context_intern (psc->nc, "daggerdbl");
  stdenc[180] = gt1_name_context_intern (psc->nc, "periodcentered");
  stdenc[182] = gt1_name_context_intern (psc->nc, "paragraph");
  stdenc[183] = gt1_name_context_intern (psc->nc, "bullet");
  stdenc[184] = gt1_name_context_intern (psc->nc, "quotesinglbase");
  stdenc[185] = gt1_name_context_intern (psc->nc, "quotedblbase");
  stdenc[186] = gt1_name_context_intern (psc->nc, "quotedblright");
  stdenc[187] = gt1_name_context_intern (psc->nc, "guillemotright");
  stdenc[188] = gt1_name_context_intern (psc->nc, "ellipsis");
  stdenc[189] = gt1_name_context_intern (psc->nc, "perthousand");
  stdenc[193] = gt1_name_context_intern (psc->nc, "grave");
  stdenc[195] = gt1_name_context_intern (psc->nc, "circumflex");
  stdenc[196] = gt1_name_context_intern (psc->nc, "tilde");
  stdenc[197] = gt1_name_context_intern (psc->nc, "macron");
  stdenc[198] = gt1_name_context_intern (psc->nc, "breve");
  stdenc[199] = gt1_name_context_intern (psc->nc, "dotaccent");
  stdenc[200] = gt1_name_context_intern (psc->nc, "dieresis");
  stdenc[202] = gt1_name_context_intern (psc->nc, "ring");
  stdenc[205] = gt1_name_context_intern (psc->nc, "hungarumlaut");
  stdenc[206] = gt1_name_context_intern (psc->nc, "ogonek");
  stdenc[207] = gt1_name_context_intern (psc->nc, "caron");
  stdenc[208] = gt1_name_context_intern (psc->nc, "emdash");
  stdenc[225] = gt1_name_context_intern (psc->nc, "AE");
  stdenc[227] = gt1_name_context_intern (psc->nc, "ordfeminine");
  stdenc[232] = gt1_name_context_intern (psc->nc, "Lslash");
  stdenc[233] = gt1_name_context_intern (psc->nc, "Oslash");
  stdenc[234] = gt1_name_context_intern (psc->nc, "OE");
  stdenc[235] = gt1_name_context_intern (psc->nc, "ordmasculine");
  stdenc[241] = gt1_name_context_intern (psc->nc, "ae");
  stdenc[245] = gt1_name_context_intern (psc->nc, "dotlessi");
  stdenc[248] = gt1_name_context_intern (psc->nc, "lslash");
  stdenc[249] = gt1_name_context_intern (psc->nc, "oslash");
  stdenc[250] = gt1_name_context_intern (psc->nc, "oe");
  stdenc[251] = gt1_name_context_intern (psc->nc, "germandbls");
#endif
  loaded_font->encoding = stdenc;
...
gt1_get_glyph_outline (Gt1LoadedFont *font, int glyphnum, double *p_wx)
{
  ...
  glyphname = font->encoding[glyphnum & 0xff]; /* cheat! */
