...
NRBPath *nr_font_get_glyph_outline (NRFont *font, int glyph, NRBPath *d, unsigned int ref);
void nr_font_unref_glyph_outline (NRFont *font, int glyph);

NRPointF *nr_font_get_glyph_advance (NRFont *font, int glyph, NRPointF *adv);
