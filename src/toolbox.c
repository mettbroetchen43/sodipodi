...
sp_maintoolbox_create (void)
{
	if (main_toolbox_dialog == NULL) {
		...
		select_box.dialog_name = " Selection ";
		...
		draw_box.dialog_name = " Draw context ";
		...
		node_box.dialog_name = " Node edit";
