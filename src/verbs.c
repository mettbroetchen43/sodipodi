...
static const SPVerbActionDef props[] = {
	...
	{SP_VERB_SELECTION_UNION, "SelectionUnion", N_("Union"), N_("Calculate union of selected paths"), "selection_union"},
	{SP_VERB_SELECTION_INTERSECTION, "SelectionIntersection", N_("Intersection"), N_("Calculate intersection of selected paths"), "selection_intersection"},
	{SP_VERB_SELECTION_SUBTRACTION, "SelectionSubtraction", N_("Subtraction"), N_("Subtract paths from first"), "selection_subtraction"},
