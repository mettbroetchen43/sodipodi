...
static void sp_stroke_sel_changed (Sodipodi * sodipodi, SPSelection * selection, gpointer data);
...
static void
sp_stroke_sel_changed (Sodipodi * sodipodi, SPSelection * selection, gpointer data)
{
	sp_stroke_read_selection ();
}
