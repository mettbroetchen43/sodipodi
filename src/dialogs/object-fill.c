...
static void sp_fill_sel_changed (Sodipodi * sodipodi, SPSelection * selection, gpointer data);
...
static void
sp_fill_sel_changed (Sodipodi * sodipodi, SPSelection * selection, gpointer data)
{
	sp_fill_read_selection ();
}
