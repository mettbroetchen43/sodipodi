...
static void nr_rgradient_render_block (NRRGradientRenderer *lgr, NRPixBlock *pb);
static void nr_rgradient_render_r8g8b8a8 (NRRGradientRenderer *lgr, unsigned char *px, int x0, int y0, int width, int height, int rs);
static void nr_rgradient_render_r8g8b8 (NRRGradientRenderer *lgr, unsigned char *px, int x0, int y0, int width, int height, int rs);
...
nr_rgradient_render_block (NRRGradientRenderer *rgr, NRPixBlock *pb)
{
	...
	if (pb->empty) {
		...
		case NR_PIXBLOCK_MODE_A8:
			break;
		case NR_PIXBLOCK_MODE_R8G8B8:
			nr_rgradient_render_r8g8b8 (rgr, pb->px, pb->area.x0, pb->area.y0, width, height, pb->rs);
			break;
		case NR_PIXBLOCK_MODE_R8G8B8A8N:
			nr_rgradient_render_r8g8b8a8 (rgr, pb->px, pb->area.x0, pb->area.y0, width, height, pb->rs);
			break;
		case NR_PIXBLOCK_MODE_R8G8B8A8P:
			break;
		default:
...
static void
nr_rgradient_render_r8g8b8a8 (NRRGradientRenderer *rgr, unsigned char *px, int x0, int y0, int width, int height, int rs)
{
	int x, y;
	unsigned char *d;
	const unsigned char *s;
...
static void
nr_rgradient_render_r8g8b8 (NRRGradientRenderer *rgr, unsigned char *px, int x0, int y0, int width, int height, int rs)
{
	int x, y;
	unsigned char *d;
	const unsigned char *s;
